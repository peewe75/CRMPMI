      ...
      <nav className="glass sticky top-0 z-50 border-b border-white/20 px-6 py-4 dark:border-slate-800">
        <div className="mx-auto flex max-w-7xl items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-8 text-sm font-medium">
            ...
            <Link href="/dashboard/assistant" className="glass rounded-full px-5 py-2 hover:bg-white/40 transition-all border-white/50">
              Accedi
            </Link>
          </div>
        </div>
      ...
      <main>
        ...
        <section className="relative px-6 pt-20 pb-32 md:pt-32">
          <div className="mx-auto max-w-7xl grid md:grid-cols-2 gap-12 items-center">
            <div className="space-y-8 animate-[page-enter_0.8s_ease-out]">
            ...
            <div className="relative animate-[page-enter_1s_ease-out]">
              ...
              {/* Floating Element */}
              <div className="glass absolute -bottom-6 -left-6 rounded-2xl p-4 shadow-xl border-white/60 animate-bounce transition-all duration-1000">
                ...
                <div className="relative w-full h-full">
                  ...
                  <div className="absolute inset-0 flex items-center justify-center gap-1.5">
                    {[1,2,3,4,5,6,7,8,7,6,5,4,3,2,1].map((h, i) => (
                      <div 
                        key={i} 
                        className="w-1.5 rounded-full bg-blue-500 animate-[waveform-bar_1.2s_ease-in-out_infinite]"
                        style={{ animationDelay: `${i * 0.1}s`, height: `${h * 10}%` }}
                      />
                    ))}
                  </div>
